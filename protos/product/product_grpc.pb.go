...
type ProductServiceClient interface {
	...
	Post(ctx context.Context, in *Product, opts ...grpc.CallOption) (*Product, error)
}
...
func (c *productServiceClient) Post(ctx context.Context, in *Product, opts ...grpc.CallOption) (*Product, error) {
	out := new(Product)
	err := c.cc.Invoke(ctx, "/product.ProductService/Post", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProductServiceServer interface {
	...
	Post(context.Context, *Product) (*Product, error)
...
func (UnimplementedProductServiceServer) Post(context.Context, *Product) (*Product, error) {
...
func _ProductService_Post_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Product)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServiceServer).Post(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/product.ProductService/Post",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).Post(ctx, req.(*Product))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Post",
			Handler:    _ProductService_Post_Handler,
		},
	},
